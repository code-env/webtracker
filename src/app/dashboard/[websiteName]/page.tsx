...
export default function DashboardPage({
  ...
  const formatCountryData = (): CountryChartData[] => {
    ...
    return analyticsData.analytics.countryAnalytics
      .sort(
        (a: CountryAnalytics, b: CountryAnalytics) => b.visitors - a.visitors
      )
      .slice(0, 5)
  ...
  const formatRouteData = (): BarChartData[] => {
    ...
    return analyticsData.analytics.routeAnalytics
      .sort(
        (a: RouteAnalytics, b: RouteAnalytics) => b.pageVisits - a.pageVisits
      )
      .slice(0, 5)
  ...
  if (responseStatus === 403) {
    return (
      <div className="bg-white rounded-xl h-full shadow-md p-8 text-center">
                          ...
                          {trafficSourcesData.length > 0 ? (
                            ...
                            <div className="h-full w-full flex items-center justify-center">
                              <p className="text-gray-500 text-center">
                                <span className="block text-4xl mb-2 text-blue-300">
                                  📊
                                </span>
                      ...
                      <div className="h-72">
                        <ResponsiveContainer width="100%" height="100%">
                          {deviceData.length > 0 ? (
                              ...
                              >
                                {deviceData.map((entry, index) => (
                                  <Cell
                                    key={`cell-${index}`}
                                    fill={
                                      COLORS.green[index % COLORS.green.length]
                                    }
                                  />
                                ))}
                              </Pie>
                            ...
                            <div className="h-full w-full flex items-center justify-center">
                              <p className="text-gray-500 text-center">
                                <span className="block text-4xl mb-2 text-green-300">
                                  📱
                                </span>
